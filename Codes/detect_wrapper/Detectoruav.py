...
class DroneDetection:
    def __init__(self, IRweights_path: str, RGBweights_path: str):
        ...
        #     log.error(f"Error in parsing arguments: {e}")
        #     raise Exception(f"Error in parsing arguments: {e}")

        self.opt = lambda: None
        self.opt.IRweights = IRweights_path
        self.opt.RGBweights = RGBweights_path
        self.opt.image_size = 640
        self.opt.conf_thres = 0.25
        self.opt.iou_thres = 0.45
        self.opt.device = '0'
        self.opt.view_img=False
        self.opt.save_txt=False
        self.opt.save_conf=False
        
        self.opt.save_dir = 'inference/output'
        self.opt.augment = False
        self.opt.agnostic_nms = False
        self.opt.classes = None
        self.opt.update = False
